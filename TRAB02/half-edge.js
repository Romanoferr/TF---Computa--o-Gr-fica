...
export class HalfEdgeDS {
  ...
  build(coords, trigs) {
    // construção dos vértices - ajustado para apenas 3 coordenadas
    for (let vid = 0; vid < coords.length; vid+=3) {
      ...
      // console.log('conteudo vertex: ', v);
      this.vertices.push(v);
    }

    // TODO: TENTAR ENTENDER O CÓDIGO ABAIXO - ajuste faces? o que é halfedge?
    // acho que se for necessário ajuste de faces, pode exibir a imagem corretamente
