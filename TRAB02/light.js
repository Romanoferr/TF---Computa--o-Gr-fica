export default class Light {
  constructor(str) {
    if(str == 'fixa'){
      this.pos = vec4.fromValues(1.0, 1.0, 1.0, 0.0);

      this.amb_c = vec4.fromValues(3.0, 3.0, 1.0, 1.0);
      this.amb_k = 0.1;

      this.dif_c = vec4.fromValues(3.0, 3.0, 1.0, 1.0);
      this.dif_k = 0.8;
      ...
      this.pos = vec4.fromValues(3.0, 3.0, 1.0, 1.0);

      this.amb_c = vec4.fromValues(2.0, 1.0, 1.0, 1.0);
      this.amb_k = 0.1;
